// Purpose: Executor for mistral / embeddings.
// Why: Isolates provider-specific behavior per capability.
// How: Maps IR embeddings to Mistral embeddings API (OpenAI-compatible) and normalizes usage.

// Mistral Embeddings - mistral-embed and codestral-embed models
// Documentation: https://docs.mistral.ai/api/endpoint/embeddings
// Models: mistral-embed (1024-dim text), codestral-embed (1024-dim code)
