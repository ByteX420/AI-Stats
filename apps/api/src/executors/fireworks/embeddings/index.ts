// Purpose: Executor for fireworks / embeddings.
// Why: Isolates provider-specific behavior per capability.
// How: Maps IR embeddings to Fireworks AI embeddings API (OpenAI-compatible) and normalizes usage.

// Fireworks AI Embeddings - Qwen3 Embeddings, nomic-embed-text models
// Documentation: https://docs.fireworks.ai/
// Models: Qwen/Qwen3-embeddings-8B, nomic-ai/nomic-embed-text-v1.5, etc.
