// Purpose: Executor for openai / audio.transcription (STT).
// Why: Isolates provider-specific behavior per capability.
// How: Maps IR audio transcription requests to OpenAI Whisper API.

// OpenAI Audio Transcription (STT) - Speech-to-Text
...
export async function execute(args: ExecutorExecuteArgs): Promise<ExecutorResult> {
	...
	// Build OpenAI transcription request (multipart/form-data)
	...
	if (ir.language) formData.append("language", ir.language);
	...
	const responseIr: IRAudioTranscriptionResponse = {
		id: args.requestId,
